...
public class Config {
    ...
    public static final String API_SERVER_URL = "ENTER_YOUR_API_SERVER_URL_HERE";
    ...
    public static final String TERMS_URL = "ENTER_YOUR_API_TERMS_AND_CONDITION_URL_HERE";
