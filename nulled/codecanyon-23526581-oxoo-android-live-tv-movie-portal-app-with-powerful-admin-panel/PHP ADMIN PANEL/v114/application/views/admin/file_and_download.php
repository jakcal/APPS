<div class="card">
  ...
  <div class="col-md-12">
    <div class="panel panel-border panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title">External Download URL</h3>
        </div>
        <div class="panel-body">          
          <div id="download_link_section">
            ...
            <div class="form-group" id="">
              <label class="control-label" >Resolution</label>&nbsp;&nbsp;<input id="resolution" type="text" name="resolution[]" class="form-control" placeholder="720p" required="">
            </div>
            <div class="form-group" id="">
              <label class="control-label" >File Size</label>&nbsp;&nbsp;<input id="file_size" type="text" name="file_size[]" class="form-control" placeholder="300MB" required="">
            </div>
            <div class="form-group" id="">
    ...
    <div class="panel panel-border panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title">External Download Link List</h3>
        </div>
        <div class="panel-body">                
