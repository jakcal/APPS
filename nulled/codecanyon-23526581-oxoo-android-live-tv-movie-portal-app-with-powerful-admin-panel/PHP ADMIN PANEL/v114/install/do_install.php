...
if (isset($_POST)) {
    ...
    // genarate android api key
    $api_key_for_android = substr(md5(rand()), 0, 16);
    $sql = str_replace('api_key_for_android', $api_key_for_android, $sql);
    // genarate cron key
    $cron_key_for_cron_job = substr(md5(rand()), 0, 16);
    $sql = str_replace('cron_key_for_cron_job', $cron_key_for_cron_job, $sql);
    ...
    $encryption_key = substr(md5(rand()), 0, 32);
